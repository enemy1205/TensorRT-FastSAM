...
if __name__ == '__main__':
    img = cv2.imread('images/58769465_p0.png')
    inp = pre_processing(img)
    # print(inp.shape)
    print('Input: ', inp.shape)
    model = onnxruntime.InferenceSession('models/fast_sam_x.onnx', providers=['CUDAExecutionProvider'])
    ...
    cv2.imwrite("outputs/my_1.png", image_with_masks)